...
import { ShopContext } from '../context/ShopContext'; // Ensure this path is correct and provides setShowSearch and getCartCount
...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        {/* side bar menu is for smaller screen */}
